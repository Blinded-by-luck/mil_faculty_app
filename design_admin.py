...
class Ui_interface_admin(object):
    def setupUi(self, interface_admin):
        ...
        self.add_concentrator_btn = QtWidgets.QPushButton(self.centralwidget)
        self.add_concentrator_btn.setGeometry(QtCore.QRect(0, 170, 41, 31))
        self.add_concentrator_btn.setStyleSheet("background-color: rgb(0, 170, 255);")
        self.add_concentrator_btn.setText("")
        self.add_concentrator_btn.setIcon(icon2)
        self.add_concentrator_btn.setIconSize(QtCore.QSize(32, 32))
        self.add_concentrator_btn.setObjectName("add_concentrator_btn")
